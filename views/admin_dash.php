...
<body>
  ...
  ?>
        <div class="bonjour">
            ...
            <p>Bienvenue, <?php echo htmlspecialchars($_SESSION['firstname']); ?> !</p>
        </div>
    <div class="new_piece">
            ...
            <tbody>
                <?php foreach ($pieces as $piece): ?>
                    <tr>
                        ...
                        <td class="nom"><?php echo htmlspecialchars($piece['nom_piece']); ?></td>
                        ...
                        <td class="actions">
                            <a id="edit" href="/edit_piece?action=edit&id_piece=<?php echo $piece['id_piece']; ?>">Modifier</a>
                            <a id="supp" href="/admin_dash?action=delete&id_piece=<?php echo $piece['id_piece']; ?>" 
